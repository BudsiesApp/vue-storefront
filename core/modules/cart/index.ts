...
const IS_SHIPPING_METHODS_SYNCING_ERROR = `${SN_CART}/${getterTypes.IS_SHIPPING_METHODS_SYNCING_ERROR}`
...
const IS_COUPON_INTERACTION_BLOCKED = `${SN_CART}/${getterTypes.IS_COUPON_INTERACTION_BLOCKED}`
...
export { useCouponButton } from './composables/use-coupon-button';
export type { CouponButtonState } from './composables/use-coupon-button';
