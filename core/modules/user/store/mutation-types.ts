...
export const USER_SESSION_STARTED = SN_USER + '/SESSION_STARTED'
...
export const SET_USER_REFRESH_TOKEN = SN_USER + '/SET_USER_REFRESH_TOKEN'
export const SET_USER_TOKEN = SN_USER + '/SET_USER_TOKEN';
export const SET_TOKEN_REFRESH_PROMISE = SN_USER + '/SET_TOKEN_REFRESH_PROMISE';
export const INCREMENT_TOKEN_REFRESH_COUNT = SN_USER + '/INCREMENT_TOKEN_REFRESH_COUNT';
export const RESET_TOKEN_REFRESH_COUNT = SN_USER + '/RESET_TOKEN_REFRESH_COUNT';
