...
export const PRODUCT_REMOVE_BUNDLE_OPTION = SN_PRODUCT + '/PRODUCT_REMOVE_BUNDLE_OPTION'
export const PRODUCT_SET_GALLERY = SN_PRODUCT + '/SET_PRODUCT_GALLERY'
export const PRODUCT_SET_PRODUCT_BY_SKU = SN_PRODUCT + '/PRODUCT_SET_PRODUCT_BY_SKU'
export const PRODUCT_UNSET_CURRENT = SN_PRODUCT + '/PRODUCT_UNSET_CURRENT'
export const PRODUCT_SET_DISCOUNTS = SN_PRODUCT + '/PRODUCT_SET_DISCOUNTS'
// remove later
